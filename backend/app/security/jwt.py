...
def create_access_token(subject: str, role: str, expires_delta: timedelta | None = None) -> str:
    ...
    payload = {"sub": str(subject), "role": role, "iat": int(now.timestamp()), "exp": int(expire.timestamp())}
...
def decode_access_token(token: str) -> dict:
    ...
    try:
        ...
        raise jwt.PyJWTError("Token signature or formatting is invalid.") from None
